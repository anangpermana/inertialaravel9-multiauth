            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            <!-- Logo -->
                            <div v-if="$page.props.auth.user.role == 'admin'" class="shrink-0 flex items-center">
                            ...
                            <div v-else-if="$page.props.auth.user.role == 'user'" class="shrink-0 flex items-center">
                            ...
                            <div v-else-if="$page.props.auth.user.role == 'user'" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                >
                    ...
                    <div v-else-if="$page.props.auth.user.role == 'user'" class="pt-2 pb-3 space-y-1">
